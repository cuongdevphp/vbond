        ...
        if(rsDup.recordset.length === 0) {
            try {
                ...
                await pool.request().query(`
                    ...
                    (${rs.recordset[0].BONDID}, ${LAISUAT_MUA}, ${1}, ${moment(NGAYPH).toISOString()}, ${moment(new Date(new Date(new Date(NGAYPH)).setMonth(new Date(NGAYPH).getMonth()+KYHAN))).toISOString()}, '${moment().toISOString()}', ${1});
                `);
